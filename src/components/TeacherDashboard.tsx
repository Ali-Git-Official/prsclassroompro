            ...
            {activeTab === 'reports' && (
              <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-xs space-y-4" id="prs-reports-suite">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-right font-sans">
                  ...
                  {/* Attendance Card */}
                  <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-4 flex flex-col justify-between text-right">
                    <div>
                    ...
                    <button
                      ...
                      className="mt-4 w-full py-1.5 bg-indigo-650 hover:bg-indigo-600 text-white font-extrabold text-[10px] rounded-lg transition-all cursor-pointer flex items-center justify-center gap-1 active:scale-95"
                    >
                      <Download size={11} />
