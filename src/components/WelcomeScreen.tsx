          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <button
                ...
                className="p-6 border border-slate-200/80 hover:border-indigo-600 rounded-2xl bg-white hover:bg-indigo-50/10 shadow-sm hover:shadow-md text-right transition-all duration-300 flex flex-col justify-between group active:scale-[0.98] cursor-pointer"
                id="select-role-teacher"
              >
                <div className="w-11 h-11 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300 shadow-sm">
                  <UserCheck size={20} className="transition-transform group-hover:scale-110 duration-300" />
                </div>
                <div className="mt-8 space-y-1">
                  <span className="text-xs font-extrabold text-slate-900 block group-hover:text-indigo-700 transition-colors">ورود مدرس / معلم</span>
              ...
              <button
                ...
                className="p-6 border border-slate-200/80 hover:border-teal-600 rounded-2xl bg-white hover:bg-teal-50/10 shadow-sm hover:shadow-md text-right transition-all duration-300 flex flex-col justify-between group active:scale-[0.98] cursor-pointer"
                id="select-role-student"
              >
                <div className="w-11 h-11 rounded-xl bg-teal-50 text-teal-600 flex items-center justify-center group-hover:bg-teal-600 group-hover:text-white transition-all duration-300 shadow-sm">
