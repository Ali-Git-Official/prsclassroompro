        ...
        <div className="flex items-center gap-2.5 w-full md:w-auto justify-end sm:justify-start">
          ...
          {externalClassUrl && (
            <button 
              ...
              className="px-3 py-2 bg-indigo-50/80 border border-indigo-200 hover:bg-slate-900 hover:text-white hover:border-slate-900 text-indigo-750 rounded-xl text-xs font-bold transition-all flex items-center gap-1 cursor-pointer"
              id="student-copy-url-top"
            >
              <Link size={12} />
              <span>{copiedLink ? "با موفقیت کپی شد! ✓" : "کپی لینک کلاس"}</span>
            </button>
          )}
            ...
            {activeTab === 'whiteboard' && (
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-xs p-1">
                <div className="p-3 bg-white border-b border-slate-100 flex justify-between items-center bg-gray-50/20">
                  <span className="text-[10px] text-indigo-650 font-bold bg-indigo-50 px-2 py-0.5 rounded-full flex items-center gap-1">
